...
PARKED = (
    # explicit for-sale / parked phrasing
    "domain is for sale", "this domain is for sale", "domain name is for sale",
    "this domain name is for sale", "the domain name", "buy this domain",
    "this domain may be for sale", "domain for sale", "domain parking",
    "is parked", "parked free", "this domain is parked", "this domain has expired",
    "the domain has expired", "domain has expired", "renew now to keep",
    "the owner of this domain", "interested in this domain",
    "inquire about this domain", "enquire about this domain",
    "checkout the full domain details", "get this domain", "own it today",
    "this webpage was generated by the domain owner",
    "this domain is connected to a", "buy a domain",
    # parking / aftermarket / registrar lander providers
    "hugedomains", "sedoparking", "sedo.com", "parkingcrew", "bodis.com",
    "afternic", "dan.com", "domainmarket.com", "above.com", "uniregistry",
    "sav.com", "epik.com", "domainagents", "namebright", "fabulous.com",
    "godaddy.com/domainsearch", "courtesy of godaddy",
    "godaddy operating company", "this premium domain",
)

# Provider footprints in the page TITLE alone (a real store's title is its brand).
PARKED_TITLE = (
    "domain for sale", "is for sale", "for sale -", "buy domain",
    "hugedomains", "sedo", "dan.com", "afternic", "premium domain", "parked",
)
...
def _looks_parked(low, title, domain):
    """True if a fetched page is a parking / for-sale / expired lander rather than
    a real brand site. Combines explicit markers with cheap structural heuristics
    so registrar landers (GoDaddy/Afternic/Sedo/…) are caught without nuking real
    stores."""
    ...
    # "<thisdomain> is for sale" style landers: the for-sale phrase next to the
    # domain/its stem is a strong signal a real store would not produce.
    if "for sale" in low and (domain in low or (stem and stem in tl)):
        return True
    if ("make an offer" in low or "buy now" in low) and "for sale" in low:
        return True
    return False
